...
def add_ride():
	...
	if request.method == 'POST':
		...
		custom_headers = {'Origin':'52.0.47.235'}	#fill ip with public ip or dns ip of rides instance
		response_received = send_request.get('http://CC-Assignment-3-907148319.us-east-1.elb.amazonaws.com/api/v1/users',headers = custom_headers) #fill the ip with that of load balancer
...
def delete_ride(rideId):
	...
	if request.method == "POST":
		...
		custom_headers = {'Origin':'52.0.47.235'}
		response_received = send_request.get("http://CC-Assignment-3-907148319.us-east-1.elb.amazonaws.com/api/v1/users",headers = custom_headers)
